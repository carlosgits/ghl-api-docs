...
Screenshot: C:\Users\carlo\OneDrive\Desktop\Proyectos\ghl-api-docs\images\ghl_users_update-user_screenshot.png

---

UsersUsersUpdate User
Update User
PUT
...
POWERSHELL
CURL
curl -L -X PUT 'https://services.leadconnectorhq.com/users/:userId' \
